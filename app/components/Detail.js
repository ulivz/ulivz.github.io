	...
	render() {
		return (
			<div className="container-fluid">
				<div className="container-fluid">
					<div className="row v2js-post-entry single-entry">
						<article
							className="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
							<figure className="animate-box">
								<img src="static/images/single_1.jpg" alt="Image" className="img-responsive"/>
							</figure>
							<h2 className="v2js-article-title animate-box"><a href="single.html">2017</a></h2>
							<span className="v2js-meta v2js-date animate-box">April 3th, 2017</span>

							<div
								className="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
								<div className="row">
									<div className="col-lg-8 cp-r animate-box">
										<p>Far far away, behind the word mountains, far from the countries Vokalia and
											Consonantia, there live the blind texts. Separated they live in
											Bookmarksgrove right at the coast of the Semantics, a large <a href="#">language</a>
										...
										<p>She packed her seven versalia, put her initial into the belt and made herself
											on the way. When she reached the first hills of the Italic Mountains, she
									...
									<div className="col-lg-4 animate-box">
										<div className="v2js-highlight right">
											<h4>Highlight</h4>
								...
								<div className="row rp-b">
									<div className="col-md-12 animate-box">
										<blockquote>
											<p>&ldquo;She packed her seven versalia, put her initial into the belt and
												...
												Bookmarksgrove &rdquo; <cite>&mdash; Jean Smith</cite></p>
										</blockquote>
									</div>
								</div>
								...
								<div className="row rp-b">
									<div className="col-lg-6 col-md-12 animate-box">
										<figure>
											<img src="staticstatic/images/pic_1.jpg"
											     alt="Free HTML5 Bootstrap Template by FREEHTML5.co"
											     className="img-responsive"/>
												<figcaption>
													This is a sweet image caption. Far far away, behind the word
